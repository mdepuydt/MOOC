...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = allTweets.filter(x => google.exists(s => s.contains(x.text)))
  lazy val appleTweets: TweetSet = allTweets.filter(x => google.exists(s => s.contains(x.text)))
